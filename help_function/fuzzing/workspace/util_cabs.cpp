...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
  ...
  sycl::float2 f1 = ConvertData<sycl::float2>(data);
  sycl::float2 f2 = ConvertData<sycl::float2>(data + sizeof(f1));
  sycl::double2 d1 = ConvertData<sycl::double2>(data + sizeof(f1) + sizeof(f2));
  sycl::double2 d2 = ConvertData<sycl::double2>(data + sizeof(f1) + sizeof(f2) + sizeof(d2));
