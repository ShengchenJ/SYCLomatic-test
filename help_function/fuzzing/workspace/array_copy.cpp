...
// int main(){ 
  ...
  /// ain init zero.
  dpct::dpct_memcpy(ain->to_pitched_data(), sycl::id<3>(0, 0, 0), dpct::pitched_data(out, Size * sizeof(int), Size * sizeof(int), 1), sycl::id<3>(0, 0, 0), sycl::range<3>(Size * sizeof(int), 1, 1));
  // aout init zero.
  dpct::dpct_memcpy(aout->to_pitched_data(), sycl::id<3>(0, 0, 0), dpct::pitched_data(out, Size * sizeof(int), Size * sizeof(int), 1), sycl::id<3>(0, 0, 0), sycl::range<3>(Size * sizeof(int), 1, 1));
  
  /// copy in [0, 224) to ain [32, Size).
  dpct::dpct_memcpy(ain->to_pitched_data(), sycl::id<3>(32 * sizeof(int), 0, 0), dpct::pitched_data(in, Size * sizeof(int), Size * sizeof(int), 1), sycl::id<3>(0, 0, 0), sycl::range<3>(224 * sizeof(int), 1, 1));
  ...
  dpct::dpct_memcpy(dpct::pitched_data(out, Size * sizeof(int), Size * sizeof(int), 1), sycl::id<3>(0, 0, 0), aout->to_pitched_data(), sycl::id<3>(0, 0, 0), sycl::range<3>(224 * sizeof(int), 1, 1));
