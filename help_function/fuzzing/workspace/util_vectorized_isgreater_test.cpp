...
void vec_max_test_1(const uint8_t *Data, size_t Size) {
  dpct::device_ext &dev_ct1 = dpct::get_current_device();
  sycl::queue &q_ct1 = dev_ct1.default_queue();

  const unsigned int num_data = (const unsigned int)Size / 10;
...
void vec_max_test_2(const uint8_t *Data, size_t Size) {
  dpct::device_ext &dev_ct1 = dpct::get_current_device();
  sycl::queue &q_ct1 = dev_ct1.default_queue();
...
void vec_max_test_3(const uint8_t *Data, size_t Size) {
  dpct::device_ext &dev_ct1 = dpct::get_current_device();
  sycl::queue &q_ct1 = dev_ct1.default_queue();
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *Data, size_t Size) {
  ...
  vec_max_test_1(Data, Size);
  std::cout << "\n===== vec_max_test_2 ====" << std::endl;
  vec_max_test_2(Data, Size);
  std::cout << "\n===== vec_max_test_3 ====" << std::endl;
  vec_max_test_3(Data, Size);
